...
ods tagsets.excelxp file="t38.xls"
...
proc report data=VolumeExpense missing nofs nocenter completerows completecols; 
...
define Cost / sum 'Cost' style={tagattr='type:number format:#,##0.00'};
define totcost / sum 'Total Cost' width=10 format=comma10.2 style={tagattr='type:number format:#,##0.00'};
; 
compute provmc; 
