...
ods tagsets.excelxp file="t35.xls" options(autofilter='2' autofilter_table='3'
     sheet_interval='proc');

ods html file="t35.html";
...
title2 'specifying sheet_interval=proc, autofilter_table=3,
autofilter=2';
...
proc sort data=beets;
  by harvest;
run;



proc print data=beets;
  by harvest;
run;                                 
