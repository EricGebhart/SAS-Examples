proc template;
    ...
    define event quick_reference;
        ...
        putlog "     Also available as a macro variable";
        putlog " ";
        putlog "uniform:  Default Value 'No'";
        putlog "     Current Value: " $uniform;
        putlog "     This option causes all space to be divided between the panels equally.";
        putlog "     placed vertically while this panel is active.";
        putlog " ";
        putlog "pagebreak:  Default Value 'Yes'";
        putlog "     Current Value: " $pagebreak;
        putlog "     If this option is set to no, The pagebreakhtml style element is not printed.";
        putlog " ";
        putlog "------------------------------------------------------------------------";
        ...
        define event setup_options;
            ...
            do /if $options['UNIFORM'];
                do /if cmp($options['UNIFORM'], "yes");
                    set $uniform "true"; 
                else;
                    unset $uniform; 
                done;
            ...
            do /if $options['PAGEBREAK'];
                do /if cmp($options['PAGEBREAK'], "no");
                    unset $pagebreak; 
                else;
                    set $page_break "true"; 
                done;
        ...
        define event real_panel;
            start:
                ...
                do /if ($uniform);
                    eval $uniform_width 100 / $panel_columns;
                    putq ' width=' $uniform_width;
                done;
                put ">" nl;
        ...
        define event pagebreak;
            put PAGEBREAKHTML nl /if ($pagebreak);
