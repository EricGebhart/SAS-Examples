...
*/
    ...
    define tagset tagsets.text_map;
        ...
        define event doc;
            ...
            finish:
                ...
                put "/*--                                                        --*/" CR;
                put "/*-- Except my indention is wrong.  I'll have to            --*/" CR;
        ...
        define event table_body;
          ...
          finish:
             put CR;
             put "/*------------------------------------------------------------*/" CR;
             put "/*-- The endis the start of Table body, see the value of      --*/" CR;
             put "/*-- section change....                                     --*/" CR;
             put "/*------------------------------------------------------------*/" CR;
             trigger basic;
        end;
    ...
    define tagset tagsets.supermap;
        ...
        define event put_all_vars;
            ...
            else /if contains($variable_family_list, 'style'); 
                putvars style " " _name_ '="' _value_ '"';
            else /if contains($variable_family_list, 'mem'); 
                putvars mem   " " _name_ '="' _value_ '"';
            else /if contains($variable_family_list, 'dyn'); 
        ...
        define event filter_vars;
            put " " _name_ '="' _value_ '"'/breakif contains($filter_variable_list, _name_); 
