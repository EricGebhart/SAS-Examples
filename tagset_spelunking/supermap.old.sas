...
proc template;
    define tagset tagsets.supermap;
        ...
        define event help;
            ...
            putlog " ";
            putlog '        ods tagsets.supermap file="test.xml"';
        ...
        define event basic_plus;
            start:
                ...
                trigger put_some_ex_vars /if cmp($extra_event_verbosity, "some");
                put "/" / if empty;
                put "]" nl;
                break / if empty;
                ndent;
        ...
        define event filter_vars;
            put " " _name_ "=" _value_ /if contains($variable_list, _name_); 
        end;
...
ods tagsets.supermap file="map.xml";
...
ods tagsets.supermap file="map_b.xml" options(basic_events="data" Extra_events="table" );
...
ods tagsets.supermap file="map_c.xml" 
