...
proc template;
    ...
    define tagset tagsets.phtml;
        ...
        /*-------------------------------------------------------dan--*/
        /*- If 'no', no bylines are output, but the event still works */
        /*----------------------------------------------------27Sep05-*/
        mvar bylines;
      ...
      /**************************************************************/
        ...
        define event readfile;
            ...
            do /if ^$frefcount;
                ...
                eval $frefcount $frefcount+1;
            done;
            
            set $filrf "fref" $frefcount;
            
            putlog "Reading file:" $read_file;
       ...
       define event process_data;
        ...
        define event head_search;
            trigger integrated_link /if contains($record, '</head>');
        end;
...
/*------------------------------------------------------------27Apr04-*/
       ...
       define event scroll_code;
           ...
           putl "//";
            ...
            putl "    cell.style.fontSize = 'small';";
            putl "    cell.style.fontWeight = 'bold';";
    ...
    define event quick_reference;
        ...
        putlog " ";
        putlog "head_file:   Default Value 'none'";
        putlog "    File to read in and put in place of the head section of a document";
        putlog "    A foot file must also be specified as well as the notop option on the ods statement";
        putlog " ";
        putlog "foot_file:   Default Value 'none'";
        putlog "    File to read in and put in place of the foot section of a document";
        putlog "    A head file must also be specified as well as the notop option on the ods statement";
        putlog " ";
        putlog "Panelling:   Default Value 'no'";
        putlog "     Turn on automatic panelling for graph procedures.";
        putlog " ";
        ...
        putlog "==============================================================================";
        putlog " ";
        putlog "Additional inline format functions that may be useful.";
        putlog "  These functions may also be called with the ods html event= statement";
        putlog " ";
        putlog "  inline_image:";
        putlog "      ~{inline_image test.jpg}";
        putlog "     This function will place an image in the current output.";
        putlog " ";
        putlog "  include_file:";
        putlog "      ~{include_file test.txt}";
        putlog "     This function will read an external file and place it's contents in the output.";
        putlog " ";
        putlog "  include_newlines:";
        putlog "      ~{include_newlines yes}";
        putlog "     This function will cause include_file to place a break at the end of each line";
        putlog "     that it reads from external file so that newlines are preserved.";
        putlog " ";
        putlog "==============================================================================";
        putlog " ";
        putlog "Panelling Options";
        putlog " ";
        putlog "Doc:  No default value.";
        putlog "     Help: Displays introductory text and options.";
        putlog "     Quick: Displays available options.";
        ...
        putlog "     Also available as a macro variable.";
        putlog " ";
        putlog "ByLines:   Default Value 'Yes'";
        putlog "     Current Value: " $bylines;
        putlog "     If 'No' do not generate any bylines.";
        putlog "     Also available as a macro variable.";
        putlog " ";
        putlog "------------------------------------------------------------------------";
        ...
        putlog " ";
        putlog "Automatic panelling must be turned on with the panelling option.";
        putlog " ";
        putlog "Panel:   ";
       ...
       define event set_scroll_options;
        ...
        define event set_options;
            ...
            unset $automatic_panelling;
            unset $panelling;
            do / if cmp($options['PANELLING'], 'yes');
                set $panelling "True";
                set $automatic_panelling "True";
            done;
            ...
            do /if  $options['FOOT_FILE'];
                set $foot_file $options['FOOT_FILE'];
            done;
            
            putlog "head" ":" $head_file;
            putlog "foot" ":" $foot_file;
            /*---------------------------------------------------------eric-*/
            /*-- Set a flag so the ending document tags can be suppressed.--*/
            /*------------------------------------------------------8Nov 03-*/
            do /if exists($head_file, $foot_file);
                set $read_files 'true';
                set $read_head "true";
            done;
        end;

        define event Panel_setup_options;
            trigger Panel_init_vars;
            /*---------------------------------------------------eric-*/
            ...
            /* drop the bylines, default is not to drop */
            do /if $options['BYLINES'];
                set $nobylines "true"       /if cmp($options['BYLINES'], "no");
                set $bylines "yes";

            else /if cmp(bylines, 'no');
                set $nobylines 'true';
                set $bylines "no";
            done;
        ...
        define event Panel_init_vars;
            unset $panel_columns;
            unset $panelborder;
            unset $embedded_titles;
            set $bylabels "yes";  /* just for the documentation */
            set $bylines "yes";  /* just for the documentation */
            unset $nobylabels;
            unset $nobylines;
        ...
        define event proc_list;
            ...
            set $proc_list['Gkpi'] '1';
            set $proc_list['Gtile'] '1';
            set $proc_list['Sgplot'] '1';
            set $proc_list['Sgscatter'] '1';
            set $proc_list['Sgrender'] '1';
        end;
       ...
       define event sub;
        ...
        define event real_panel;
            ...
            finish:
                ...
                do / if $panel_stack;
                    ...
                    set $automatic_panelling "true" /if $panelling;
                    put "<br>" CR;
        ...
        define event panel_cell;
            start:
                ...
                put $$byline;
                unset $$byline;
                unset $finished_panel;

            finish:

                do /if ^$finished_panel;
                    put $$setup_footers /if $embedded_titles;
                done;

                set $finished_panel "True";
        ...
        define event row_panel;
            start:
                ...
                trigger real_panel finish /if $automatic_panelling;
                unset $automatic_panelling;
